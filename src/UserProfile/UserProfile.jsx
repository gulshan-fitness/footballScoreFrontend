...
export default function UserProfileDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black to-gray-900 text-white px-4 sm:px-6 md:px-10 py-8">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button className="bg-white text-black px-4 py-2 rounded-lg font-semibold hover:bg-gray-200 transition text-sm sm:text-base">
              <FaEdit className="inline mr-2" /> Edit Profile
            </button>
            <button className="bg-transparent border border-white px-4 py-2 rounded-lg font-semibold hover:bg-white hover:text-black transition text-sm sm:text-base">
        ...
        {/* Profile Summary */}
        <div className="bg-black border border-white/30 rounded-2xl shadow-lg p-5 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
          <div className="bg-white text-black p-4 sm:p-5 rounded-full text-3xl sm:text-4xl shadow-md">
            <FaUser />
          </div>
          <div>
        ...
        {/* Account Info */}
        <div className="bg-[#1a1a1a] border border-white/20 rounded-2xl p-5 sm:p-6 space-y-4">
...
function StatCard({ icon, label, value }) {
  return (
    <div className="bg-[#0e0e0e] border border-white/20 rounded-xl p-4 flex items-center gap-4 shadow-md hover:shadow-white/30 hover:scale-105 transition">
